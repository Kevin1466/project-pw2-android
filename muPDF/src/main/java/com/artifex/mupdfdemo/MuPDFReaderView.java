...
//
//    public void setmListViewAdapter(HorizontalListViewAdapter adapter){
    ...
    public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX,
        ...
        switch (mMode) {
            case Viewing:
                if (!tapDisabled)
                    onDocMotion();
//                    mListView.scrollBy((int)distanceX);
    ...
    public boolean onScaleBegin(ScaleGestureDetector d) {
        // Disabled showing the horizontal_scrollview_land until next touch.
        // Not sure why this is needed, but without it
        // pinch zoom can make the horizontal_scrollview_land appear
        tapDisabled = true;
