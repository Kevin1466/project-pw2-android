...
//	private View mTopView;
	...
	private String videoUrl = "http://7xlkox.com5.z0.glb.clouddn.com/20ba23295a9f73fe6412.mp4";
	// 自动隐藏顶部和底部View的时间
...
//				showOrHide();
	...
	void setVideoPath(){
		String path = getIntent().getStringExtra(Constants.Extra.PATH);
		...
		if(path.startsWith("http")){
			...
			mVideo.setVideoURI(Uri.fromFile(new File(path)));
